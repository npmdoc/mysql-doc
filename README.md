# api documentation for  [mysql (v2.13.0)](https://github.com/mysqljs/mysql#readme)  [![travis-ci.org build-status](https://api.travis-ci.org/npmdoc/node-npmdoc-mysql.svg)](https://travis-ci.org/npmdoc/node-npmdoc-mysql)
